      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
          <div class="flex items-center space-x-2">
            ...
            <span class="text-xl font-bold text-gray-900 dark:text-white">Relay</span>
          </div>
      ...
      <div class="max-w-7xl mx-auto">
        <div class="text-center">
          ...
          <p class="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto mb-10">
            Eliminate manual data entry forever. Relay automatically ingests, analyzes, and provides intelligent insights from all your customer interactions across email, Slack, WhatsApp, and more.
          </p>
    ...
    <section id="features" class="py-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-black">
      <div class="max-w-7xl mx-auto">
        <div class="text-center mb-16">
          ...
          <p class="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            Relay uses advanced AI to automate your entire customer interaction lifecycle
          </p>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div class="group p-8 bg-gradient-to-br from-primary/5 to-indigo-500/5 dark:from-primary/10 dark:to-indigo-500/10 rounded-2xl border border-gray-200 dark:border-gray-800 hover:border-primary dark:hover:border-primary transition">
    ...
    <section id="benefits" class="py-20 px-4 sm:px-6 lg:px-8">
      <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div class="bg-gradient-to-br from-primary/10 to-indigo-500/10 dark:from-primary/20 dark:to-indigo-500/20 rounded-2xl p-8 border border-gray-200 dark:border-gray-800">
            <div class="space-y-6">
    ...
    <section id="technology" class="py-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-black">
      <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div class="p-8 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-950 rounded-2xl border border-gray-200 dark:border-gray-800">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul class="space-y-2 text-sm">
              ...
              <li><a href="#" class="text-gray-600 dark:text-gray-400 hover:text-primary transition">Contact</a></li>
            </ul>
          </div>
          <div>
            <h4 class="font-semibold text-gray-900 dark:text-white mb-4">Legal</h4>
            <ul class="space-y-2 text-sm">
              <li><a href="#" class="text-gray-600 dark:text-gray-400 hover:text-primary transition">Privacy</a></li>
              <li><a href="#" class="text-gray-600 dark:text-gray-400 hover:text-primary transition">Terms</a></li>
              <li><a href="#" class="text-gray-600 dark:text-gray-400 hover:text-primary transition">Security</a></li>
            </ul>
          </div>
        </div>
        <div class="pt-8 border-t border-gray-200 dark:border-gray-800 text-center text-sm text-gray-600 dark:text-gray-400">
          <p>&copy; 2025 Relay CRM. All rights reserved.</p>
        </div>
      </div>
    </footer>
  </div>
